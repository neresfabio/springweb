# ![Dev Superior logo](https://raw.githubusercontent.com/devsuperior/bds-assets/main/ds/devsuperior-logo-small.png) Semana Spring Boot - DEVSUPERIOR
...
Este é destinado a consulta, o projeto está de acordo com o desenvolvido na SEMANA SPRINGBOOT, o mesmo pode sofrer alterações futuras.

Está dividido em duas partes, BACKEND está hospedado na [HEROKU](https://www.heroku.com/), podendo não está mas funcionando.

O FRONTEND está na [NETLIFY](https://www.netlify.com/).
...
Transformando projeto Html para React ecriando seus componentes.

> ### Datepicker

Documentação: [https://github.com/Hacker0x01/react-datepicker](https://github.com/Hacker0x01/react-datepicker)
...
/>
```
> ### React Hook useState para manter o estado das datas
*Macete para criar umma data de X dias atrás:
```
...
> Configuração para conectar o h2
...
Antes: acrecente `windows.React = React` no seu main.tsx conforme abaixo, e salve um novo commit
